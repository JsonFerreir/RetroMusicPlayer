 ...
 *
 */
package cat.dam.yeison.retromusic.fragments.albums
...
import cat.dam.yeison.retromusic.EXTRA_ALBUM_ID
import cat.dam.yeison.retromusic.EXTRA_ARTIST_ID
import cat.dam.yeison.retromusic.EXTRA_ARTIST_NAME
import cat.dam.yeison.retromusic.R
import cat.dam.yeison.retromusic.activities.tageditor.AbsTagEditorActivity
import cat.dam.yeison.retromusic.activities.tageditor.AlbumTagEditorActivity
import cat.dam.yeison.retromusic.adapter.album.HorizontalAlbumAdapter
import cat.dam.yeison.retromusic.adapter.song.SimpleSongAdapter
import cat.dam.yeison.retromusic.databinding.FragmentAlbumDetailsBinding
import cat.dam.yeison.retromusic.dialogs.AddToPlaylistDialog
import cat.dam.yeison.retromusic.dialogs.DeleteSongsDialog
import cat.dam.yeison.retromusic.extensions.*
...
import cat.dam.yeison.retromusic.glide.RetroGlideExtension.artistImageOptions
import cat.dam.yeison.retromusic.glide.RetroGlideExtension.asBitmapPalette
import cat.dam.yeison.retromusic.glide.SingleColorTarget
import cat.dam.yeison.retromusic.helper.MusicPlayerRemote
import cat.dam.yeison.retromusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import cat.dam.yeison.retromusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import cat.dam.yeison.retromusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import cat.dam.yeison.retromusic.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
import cat.dam.yeison.retromusic.network.Result
import cat.dam.yeison.retromusic.network.model.LastFmAlbum
import cat.dam.yeison.retromusic.repository.RealRepository
import cat.dam.yeison.retromusic.util.*
