 ...
 *
 */
package cat.dam.yeison.retromusic.fragments.player
...
import cat.dam.yeison.retromusic.LYRICS_TYPE
import cat.dam.yeison.retromusic.R
import cat.dam.yeison.retromusic.SHOW_LYRICS
import cat.dam.yeison.retromusic.adapter.album.AlbumCoverPagerAdapter
import cat.dam.yeison.retromusic.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import cat.dam.yeison.retromusic.databinding.FragmentPlayerAlbumCoverBinding
...
import cat.dam.yeison.retromusic.fragments.base.AbsMusicServiceFragment
import cat.dam.yeison.retromusic.fragments.base.goToLyrics
import cat.dam.yeison.retromusic.helper.MusicPlayerRemote
import cat.dam.yeison.retromusic.helper.MusicProgressViewUpdateHelper
import cat.dam.yeison.retromusic.lyrics.CoverLrcView
import cat.dam.yeison.retromusic.model.lyrics.Lyrics
import cat.dam.yeison.retromusic.transform.CarousalPagerTransformer
import cat.dam.yeison.retromusic.transform.ParallaxPagerTransformer
import cat.dam.yeison.retromusic.util.CoverLyricsType
import cat.dam.yeison.retromusic.util.LyricUtil
