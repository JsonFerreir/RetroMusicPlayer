...
import cat.dam.yeison.retromusic.ADAPTIVE_COLOR_APP
import cat.dam.yeison.retromusic.ALBUM_COVER_STYLE
import cat.dam.yeison.retromusic.ALBUM_COVER_TRANSFORM
import cat.dam.yeison.retromusic.CAROUSEL_EFFECT
import cat.dam.yeison.retromusic.CIRCLE_PLAY_BUTTON
import cat.dam.yeison.retromusic.EXTRA_SONG_INFO
import cat.dam.yeison.retromusic.KEEP_SCREEN_ON
import cat.dam.yeison.retromusic.LIBRARY_CATEGORIES
import cat.dam.yeison.retromusic.NOW_PLAYING_SCREEN_ID
import cat.dam.yeison.retromusic.R
import cat.dam.yeison.retromusic.SCREEN_ON_LYRICS
import cat.dam.yeison.retromusic.SWIPE_ANYWHERE_NOW_PLAYING
import cat.dam.yeison.retromusic.SWIPE_DOWN_DISMISS
import cat.dam.yeison.retromusic.TAB_TEXT_MODE
import cat.dam.yeison.retromusic.TOGGLE_ADD_CONTROLS
import cat.dam.yeison.retromusic.TOGGLE_FULL_SCREEN
import cat.dam.yeison.retromusic.TOGGLE_VOLUME
import cat.dam.yeison.retromusic.activities.PermissionActivity
import cat.dam.yeison.retromusic.databinding.SlidingMusicPanelLayoutBinding
import cat.dam.yeison.retromusic.extensions.currentFragment
import cat.dam.yeison.retromusic.extensions.darkAccentColor
import cat.dam.yeison.retromusic.extensions.dip
import cat.dam.yeison.retromusic.extensions.getBottomInsets
import cat.dam.yeison.retromusic.extensions.hide
import cat.dam.yeison.retromusic.extensions.isColorLight
import cat.dam.yeison.retromusic.extensions.isLandscape
import cat.dam.yeison.retromusic.extensions.keepScreenOn
import cat.dam.yeison.retromusic.extensions.maybeSetScreenOn
import cat.dam.yeison.retromusic.extensions.peekHeightAnimate
import cat.dam.yeison.retromusic.extensions.setLightNavigationBar
import cat.dam.yeison.retromusic.extensions.setLightNavigationBarAuto
import cat.dam.yeison.retromusic.extensions.setLightStatusBar
import cat.dam.yeison.retromusic.extensions.setLightStatusBarAuto
import cat.dam.yeison.retromusic.extensions.setNavigationBarColorPreOreo
import cat.dam.yeison.retromusic.extensions.setTaskDescriptionColor
import cat.dam.yeison.retromusic.extensions.show
...
import cat.dam.yeison.retromusic.fragments.NowPlayingScreen
import cat.dam.yeison.retromusic.fragments.NowPlayingScreen.*
import cat.dam.yeison.retromusic.fragments.base.AbsPlayerFragment
import cat.dam.yeison.retromusic.fragments.other.MiniPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.adaptive.AdaptiveFragment
import cat.dam.yeison.retromusic.fragments.player.blur.BlurPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.card.CardFragment
import cat.dam.yeison.retromusic.fragments.player.cardblur.CardBlurFragment
import cat.dam.yeison.retromusic.fragments.player.circle.CirclePlayerFragment
import cat.dam.yeison.retromusic.fragments.player.classic.ClassicPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.color.ColorFragment
import cat.dam.yeison.retromusic.fragments.player.fit.FitFragment
import cat.dam.yeison.retromusic.fragments.player.flat.FlatPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.full.FullPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.gradient.GradientPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.material.MaterialFragment
import cat.dam.yeison.retromusic.fragments.player.md3.MD3PlayerFragment
import cat.dam.yeison.retromusic.fragments.player.normal.PlayerFragment
import cat.dam.yeison.retromusic.fragments.player.peek.PeekPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.plain.PlainPlayerFragment
import cat.dam.yeison.retromusic.fragments.player.simple.SimplePlayerFragment
import cat.dam.yeison.retromusic.fragments.player.tiny.TinyPlayerFragment
import cat.dam.yeison.retromusic.fragments.queue.PlayingQueueFragment
...
import cat.dam.yeison.retromusic.util.logD
