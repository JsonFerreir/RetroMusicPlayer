 ...
 *
 */
package cat.dam.yeison.retromusic.appwidgets
...
import cat.dam.yeison.retromusic.activities.MainActivity
import cat.dam.yeison.retromusic.appwidgets.base.BaseAppWidget
import cat.dam.yeison.retromusic.extensions.getTintedDrawable
import cat.dam.yeison.retromusic.service.MusicService
import cat.dam.yeison.retromusic.service.MusicService.Companion.ACTION_REWIND
import cat.dam.yeison.retromusic.service.MusicService.Companion.ACTION_SKIP
import cat.dam.yeison.retromusic.service.MusicService.Companion.ACTION_TOGGLE_PAUSE
    ...
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(R.drawable.ic_skip_next, ContextCompat.getColor(
                context, cat.dam.yeison.appthemehelper.R.color.md_white_1000
            )).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_prev,
        ...
        appWidgetView.setTextColor(
            R.id.title, ContextCompat.getColor(context, cat.dam.yeison.appthemehelper.R.color.md_white_1000)
        )
        appWidgetView.setTextColor(
            R.id.text, ContextCompat.getColor(context, cat.dam.yeison.appthemehelper.R.color.md_white_1000)
        )
    ...
    override fun performUpdate(service: MusicService, appWidgetIds: IntArray?) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(playPauseRes, ContextCompat.getColor(
                service, cat.dam.yeison.appthemehelper.R.color.md_white_1000)
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_next,
            service.getTintedDrawable(
                ...
                ContextCompat.getColor(
                    service,
                    cat.dam.yeison.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
