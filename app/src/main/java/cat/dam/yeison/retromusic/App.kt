...
import cat.dam.yeison.retromusic.activities.ErrorActivity
...
import cat.dam.yeison.retromusic.billing.BillingManager
import cat.dam.yeison.retromusic.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(cat.dam.yeison.appthemehelper.R.color.md_deep_purple_A200)
