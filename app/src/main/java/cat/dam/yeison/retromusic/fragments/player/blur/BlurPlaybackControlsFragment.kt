 ...
 *
 */
package cat.dam.yeison.retromusic.fragments.player.blur
...
import cat.dam.yeison.retromusic.databinding.FragmentBlurPlayerPlaybackControlsBinding
import cat.dam.yeison.retromusic.extensions.applyColor
import cat.dam.yeison.retromusic.extensions.getSongInfo
...
class BlurPlaybackControlsFragment :
    ...
    override fun setColor(color: MediaNotificationProcessor) {
        ...
        lastDisabledPlaybackControlsColor =
            ContextCompat.getColor(requireContext(), cat.dam.yeison.appthemehelper.R.color.md_grey_500)
