 ...
 */
package cat.dam.yeison.retromusic.service
...
import cat.dam.yeison.retromusic.*
import cat.dam.yeison.retromusic.activities.LockScreenActivity
import cat.dam.yeison.retromusic.appwidgets.*
import cat.dam.yeison.retromusic.auto.AutoMediaIDHelper
import cat.dam.yeison.retromusic.auto.AutoMusicProvider
import cat.dam.yeison.retromusic.extensions.showToast
import cat.dam.yeison.retromusic.extensions.toMediaSessionQueue
import cat.dam.yeison.retromusic.extensions.uri
import cat.dam.yeison.retromusic.glide.BlurTransformation
import cat.dam.yeison.retromusic.glide.RetroGlideExtension.getSongModel
import cat.dam.yeison.retromusic.glide.RetroGlideExtension.songCoverOptions
import cat.dam.yeison.retromusic.helper.ShuffleHelper.makeShuffleList
import cat.dam.yeison.retromusic.model.Song
import cat.dam.yeison.retromusic.model.Song.Companion.emptySong
import cat.dam.yeison.retromusic.model.smartplaylist.AbsSmartPlaylist
import cat.dam.yeison.retromusic.providers.HistoryStore
import cat.dam.yeison.retromusic.providers.MusicPlaybackQueueStore
import cat.dam.yeison.retromusic.providers.SongPlayCountStore
import cat.dam.yeison.retromusic.service.notification.PlayingNotification
import cat.dam.yeison.retromusic.service.notification.PlayingNotificationClassic
import cat.dam.yeison.retromusic.service.notification.PlayingNotificationImpl24
import cat.dam.yeison.retromusic.service.playback.Playback
import cat.dam.yeison.retromusic.service.playback.Playback.PlaybackCallbacks
import cat.dam.yeison.retromusic.util.MusicUtil
import cat.dam.yeison.retromusic.util.MusicUtil.toggleFavorite
import cat.dam.yeison.retromusic.util.PackageValidator
import cat.dam.yeison.retromusic.util.PreferenceUtil.crossFadeDuration
import cat.dam.yeison.retromusic.util.PreferenceUtil.isAlbumArtOnLockScreen
import cat.dam.yeison.retromusic.util.PreferenceUtil.isBluetoothSpeaker
import cat.dam.yeison.retromusic.util.PreferenceUtil.isBlurredAlbumArt
import cat.dam.yeison.retromusic.util.PreferenceUtil.isClassicNotification
import cat.dam.yeison.retromusic.util.PreferenceUtil.isHeadsetPlugged
import cat.dam.yeison.retromusic.util.PreferenceUtil.isLockScreen
import cat.dam.yeison.retromusic.util.PreferenceUtil.isPauseOnZeroVolume
import cat.dam.yeison.retromusic.util.PreferenceUtil.playbackPitch
import cat.dam.yeison.retromusic.util.PreferenceUtil.playbackSpeed
import cat.dam.yeison.retromusic.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import cat.dam.yeison.retromusic.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import cat.dam.yeison.retromusic.volume.AudioVolumeObserver
import cat.dam.yeison.retromusic.volume.OnAudioVolumeChangedListener
