...
package cat.dam.yeison.retromusic.repository

import android.content.Context
import androidx.lifecycle.LiveData
import androidx.lifecycle.map
import cat.dam.yeison.retromusic.*
import cat.dam.yeison.retromusic.db.*
import cat.dam.yeison.retromusic.fragments.search.Filter
import cat.dam.yeison.retromusic.model.*
import cat.dam.yeison.retromusic.model.smartplaylist.NotPlayedPlaylist
import cat.dam.yeison.retromusic.network.LastFMService
import cat.dam.yeison.retromusic.network.Result
import cat.dam.yeison.retromusic.network.Result.Error
import cat.dam.yeison.retromusic.network.Result.Success
