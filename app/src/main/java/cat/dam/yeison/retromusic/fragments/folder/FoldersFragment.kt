 ...
 */
package cat.dam.yeison.retromusic.fragments.folder
...
import cat.dam.yeison.appthemehelper.ThemeStore.Companion.accentColor
import cat.dam.yeison.appthemehelper.common.ATHToolbarActivity
import cat.dam.yeison.appthemehelper.util.ToolbarContentTintHelper
import cat.dam.yeison.retromusic.R
import cat.dam.yeison.retromusic.adapter.SongFileAdapter
import cat.dam.yeison.retromusic.adapter.Storage
import cat.dam.yeison.retromusic.adapter.StorageAdapter
import cat.dam.yeison.retromusic.adapter.StorageClickListener
import cat.dam.yeison.retromusic.databinding.FragmentFolderBinding
import cat.dam.yeison.retromusic.extensions.dip
import cat.dam.yeison.retromusic.extensions.showToast
import cat.dam.yeison.retromusic.extensions.textColorPrimary
import cat.dam.yeison.retromusic.extensions.textColorSecondary
import cat.dam.yeison.retromusic.fragments.base.AbsMainActivityFragment
import cat.dam.yeison.retromusic.helper.MusicPlayerRemote.openQueue
import cat.dam.yeison.retromusic.helper.menu.SongMenuHelper
import cat.dam.yeison.retromusic.helper.menu.SongsMenuHelper
import cat.dam.yeison.retromusic.interfaces.ICallbacks
import cat.dam.yeison.retromusic.interfaces.IMainActivityFragmentCallbacks
import cat.dam.yeison.retromusic.interfaces.IScrollHelper
import cat.dam.yeison.retromusic.misc.UpdateToastMediaScannerCompletionListener
import cat.dam.yeison.retromusic.misc.WrappedAsyncTaskLoader
import cat.dam.yeison.retromusic.model.Song
import cat.dam.yeison.retromusic.providers.BlacklistStore
import cat.dam.yeison.retromusic.util.FileUtil
import cat.dam.yeison.retromusic.util.PreferenceUtil.startDirectory
import cat.dam.yeison.retromusic.util.ThemedFastScroller.create
import cat.dam.yeison.retromusic.util.getExternalStorageDirectory
import cat.dam.yeison.retromusic.util.getExternalStoragePublicDirectory
import cat.dam.yeison.retromusic.views.BreadCrumbLayout
import cat.dam.yeison.retromusic.views.BreadCrumbLayout.Crumb
import cat.dam.yeison.retromusic.views.BreadCrumbLayout.SelectionCallback
