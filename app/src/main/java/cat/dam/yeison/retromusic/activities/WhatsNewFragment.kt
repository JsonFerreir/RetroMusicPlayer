...
import cat.dam.yeison.appthemehelper.util.ATHUtil.isWindowBackgroundDark
import cat.dam.yeison.appthemehelper.util.ColorUtil.isColorLight
import cat.dam.yeison.appthemehelper.util.ColorUtil.lightenColor
import cat.dam.yeison.appthemehelper.util.MaterialValueHelper.getPrimaryTextColor
import cat.dam.yeison.retromusic.BuildConfig
import cat.dam.yeison.retromusic.Constants
import cat.dam.yeison.retromusic.databinding.FragmentWhatsNewBinding
import cat.dam.yeison.retromusic.extensions.accentColor
import cat.dam.yeison.retromusic.extensions.openUrl
import cat.dam.yeison.retromusic.util.PreferenceUtil.lastVersion
